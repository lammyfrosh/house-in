...
export default function AdminPage() {
  ...
  const quickModules = [
    ...
    {
      title: "Manage Builder Updates",
      text: "Add, edit, and delete builders Updates displayed on the home page.",
      href: "/admin/builders",
      icon: Building2,
      badge: "Builders",
    },
    {
      ...
      text: "Add, edit, and delete legal service updates displayed on the home page.",
