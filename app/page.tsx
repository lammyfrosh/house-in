  ...
  return (
    <main>
      ...
      <section className="relative h-[88vh] min-h-[680px] w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-6xl flex-col justify-center px-4 pb-28 pt-24 md:pb-36">
        ...
        <div className="absolute inset-x-0 -bottom-16 z-20">
          <div className="mx-auto max-w-6xl px-4">
            <div className="rounded-[28px] border border-white/20 bg-white/95 p-4 shadow-2xl backdrop-blur-md md:p-6">
              <div className="grid gap-4 md:grid-cols-3">
                <Link
                  href="/search?purpose=sale"
                  className="group cursor-pointer rounded-3xl bg-[var(--color-primary-dark)] px-6 py-7 text-white transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-xl"
                >
      ...
      {/* SEARCH SECTION */}
      <section className="bg-[#eef2f5] pt-24 pb-10 md:pt-28 md:pb-12">
        <div className="mx-auto max-w-6xl px-4">
