    ...
    <footer className="mt-14 bg-[#111111] text-white">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3">
              <Link
                href="/add-property"
                className="inline-flex w-fit items-center justify-center rounded-xl bg-white px-4 py-2 text-xs font-extrabold uppercase tracking-widest text-black transition hover:bg-gray-200"
              >
                Add Property
              </Link>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex w-fit items-center gap-2 rounded-xl border border-gray-700 px-4 py-2 text-xs font-extrabold uppercase tracking-widest text-white transition hover:bg-[#1a1a1a]"
              >
        ...
        <div className="mt-12 border-t border-gray-800 pt-6 text-sm text-gray-500 sm:flex sm:items-center sm:justify-between">
          ...
          <p className="text-xs">Built for Nigeria • Property approval workflow enabled</p>
        </div>
      </div>
    </footer>
  );
