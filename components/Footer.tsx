        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3">
              <Link
                href="/add-property"
                className="inline-flex items-center justify-center rounded-xl bg-white px-4 py-2 text-xs font-extrabold uppercase tracking-widest text-black transition hover:bg-gray-200"
              >
                Add Property
              </Link>
